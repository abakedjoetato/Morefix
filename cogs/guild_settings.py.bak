...
class GuildSettings(commands.Cog):
    ...
    @app_commands.choices(setting=[
        ...
        app_commands.Choice(name="killfeed_channel", value="killfeed_channel"),
        app_commands.Choice(name="announcements_channel", value="announcements_channel"),
        app_commands.Choice(name="prefix", value="prefix"),
        app_commands.Choice(name="default_server", value="default_server")
    ])
    @command_handler(admin_only=True)
