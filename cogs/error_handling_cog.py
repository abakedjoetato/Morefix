...
class ErrorHandlingCog(commands.Cog):
    ...
    @app_commands.choices(error_type=[
        utils.discord_patches.app_commands.Choice(name="SFTP Connection Issues", value="sftp_connection"),
        utils.discord_patches.app_commands.Choice(name="Command Usage Help", value="command_usage"),
        utils.discord_patches.app_commands.Choice(name="Rate Limit Information", value="rate_limit"),
        utils.discord_patches.app_commands.Choice(name="Permission Problems", value="missing_permission"),
        utils.discord_patches.app_commands.Choice(name="General Troubleshooting", value="general")
    ])
