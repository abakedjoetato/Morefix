...
from utils.decorators import has_admin_permission as admin_permission_decorator
# Use standardized premium verification system
...
class CSVProcessorCog(commands.Cog):
    ...
    @premium_feature_required(feature_name="stats", min_tier=1)  # Require Survivor tier for CSV processing
    ...
    @admin_permission_decorator()
    @premium_feature_required(feature_name="stats", min_tier=1)  # Require Survivor tier for CSV cache management
    ...
    @admin_permission_decorator()
    @premium_feature_required(feature_name="stats", min_tier=1)  # Require Survivor tier
    @app_commands.autocomplete(server_id=server_id_autocomplete)
    ...
    @admin_permission_decorator()
    @premium_feature_required(feature_name="rivalries", min_tier=2)  # Require higher tier for this powerful command
    ...
    @admin_permission_decorator()
    @premium_feature_required(feature_name="stats", min_tier=1)  # Require Survivor tier for CSV status
