...
class LogProcessorCog(commands.Cog):
    ...
    async def server_id_autocomplete(self, interaction: discord.Interaction, current: str) -> List[utils.discord_patches.app_commands.Choice[str]]:
        ...
        Returns:
            List[utils.discord_patches.app_commands.Choice(name=str)]: List of server choices
        """
